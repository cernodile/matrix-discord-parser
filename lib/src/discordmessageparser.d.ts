...
export declare class DiscordMessageParser {
    FormatMessage(opts: IDiscordMessageParserOpts, msg: IDiscordMessage, replying?: boolean): Promise<IDiscordMessageParserResult>;
    ...
    InsertReply(opts: IDiscordMessageParserOpts, content: string, msg: IDiscordMessage): Promise<string>;
    InsertReplyPostmark(opts: IDiscordMessageParserOpts, content: string, msg: IDiscordMessage): Promise<string>;
