...
class DiscordMessageParser {
    FormatMessage(opts, msg, replying = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!replying)
                content = yield this.InsertReply(opts, content, msg);
            if (opts.noEmbed == false)
            ...
            if (!replying)
                contentPostmark = yield this.InsertReplyPostmark(opts, contentPostmark, msg);
            if (opts.noEmbed == false)
    ...
    InsertReply(opts, content, msg) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!opts.callbacks.getReference || !((_a = msg.reference) === null || _a === void 0 ? void 0 : _a.messageID)) {
                return content;
            }
            const reply = yield opts.callbacks.getReference(msg.reference.messageID);
            if (!reply) {
                return content;
            }
            const parsed_reply = yield this.FormatMessage(opts, reply, true);
            content = `>  ${parsed_reply.body}\n\n${content}`;
            return content;
        });
    }
    InsertReplyPostmark(opts, content, msg) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            if (!opts.callbacks.getReference || !((_a = msg.reference) === null || _a === void 0 ? void 0 : _a.messageID)) {
                return content;
